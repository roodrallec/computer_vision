function modified_phow_caltech101(classOveride, modelPrefix, numWords, phowOpts)
...
if exist('phowOpts', 'var')
    conf.phowOpts = phowOpts;
end
...
if (exist('classOveride','var')) 
    classes = classOveride;
end
images = {} ;
imageClass = {} ;
